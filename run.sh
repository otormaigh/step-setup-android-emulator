...
echo no | avdmanager create avd -f -n $WERCKER_SETUP_ANDROID_EMULATOR_TARGET_NAME -k $WERCKER_SETUP_ANDROID_EMULATOR_TARGET --abi $WERCKER_SETUP_ANDROID_EMULATOR_ABI
